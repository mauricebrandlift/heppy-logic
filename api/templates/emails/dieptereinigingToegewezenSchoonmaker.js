/**
 * Email Template: Dieptereiniging Toegewezen aan Schoonmaker
 * 
 * Wordt verzonden naar schoonmaker wanneer een dieptereiniging opdracht aan hen is toegewezen.
 ...
 */
export function dieptereinigingToegewezenSchoonmaker(data) {
  const {
    schoonmakerNaam,
    klantNaam,
    plaats,
  ...
  const content = `
    <h2>🎉 Nieuwe Dieptereiniging Opdracht!</h2>
    
    <p>Beste ${schoonmakerNaam},</p>
    
    <p>Goed nieuws! Er is een nieuwe dieptereiniging opdracht voor je beschikbaar gekomen.</p>
  ...
  return baseLayout(content, 'Nieuwe Dieptereiniging Opdracht - Heppy Schoonmaak');
}
