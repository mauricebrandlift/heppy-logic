/**
 * Email Template: Nieuwe Dieptereiniging voor Admin
 * 
 * Wordt verzonden naar admin wanneer een nieuwe dieptereiniging opdracht binnenkomt.
 ...
 */
export function nieuweDieptereinigingAdmin(data) {
  const {
    klantNaam,
    klantEmail,
    plaats,
  ...
  const content = `
    <h2>🆕 Nieuwe Dieptereiniging Opdracht Ontvangen</h2>
    
    <p>Er is een nieuwe dieptereiniging opdracht binnengekomen. De betaling is succesvol verwerkt en de opdracht is klaar voor uitvoering.</p>
  ...
  return baseLayout(content, 'Nieuwe Dieptereiniging - Heppy Schoonmaak');
}
